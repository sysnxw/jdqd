...
async function mr() {
  ...
  let client = new WebSocket(`wss://xinruimz-isv.isvjcloud.com/wss/?token=${$.token}`,null,{
    headers:{
      'user-agent': process.env.JD_USER_AGENT ? process.env.JD_USER_AGENT : "Dalvik/2.1.0 (Linux; U; Android 11; PEGT00 Build/RKQ1.200903.002)",
    }
  })
...
function getIsvToken() {
  let config = {
    ...
    headers: {
      'Host': 'api.m.jd.com',
      'accept': '*/*',
      'user-agent': 'Dalvik/2.1.0 (Linux; U; Android 11; PEGT00 Build/RKQ1.200903.002)',
